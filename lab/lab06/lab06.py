...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        try :
            ...
            print('Something went wrong. Deposit failed.')
        finally :
            return self.balance
    ...
    def withdraw(self, amount):
        ...
        try :
            ...
            print('Something went wrong. Withdrawal failed.')
        finally :
            return self.balance
...
class Mint:
    ...
    def create(self, coin):
        "*** YOUR CODE HERE ***"
        """Return a coin of the given type with the mint's current year."""
        if coin == Dime:
        ...
        # return coin(self.year)  # This will not work because coin is a class, not an instance
